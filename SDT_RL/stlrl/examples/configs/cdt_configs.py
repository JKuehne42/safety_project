...
class CDTTrainConfig:
    ...
    loss_cost_weight: float = 0
    loss_state_weight: float = 0
    loss_spec_weight: float = 0
...
class CDTCarGoal1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((36, 0.05), (40, 0.05))
    update_steps: int = 300_000
    eval_every: int = 60000
    eval_episodes: int = 5
    # augmentation param
    deg: int = 1
    max_reward: float = 50.0
...
class CDTPointGoal1Config(CDTTrainConfig):
    ...
    target_returns: Tuple[Tuple[float, ...], ...] = ((20.0, 0.05), (25.0, 0.05))
    update_steps: int = 300_000
    eval_every: int = 60000
    eval_episodes: int = 5
    # augmentation param
