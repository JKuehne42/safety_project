...
class AntJumpEnv(EnvironmentBuilder):
    def __init__(self):
        agent = "Ant"
        task = "JumpTask"
        obstacles = {}
...
class OfflineAntJumpEnv(AntJumpEnv, offline_env.OfflineEnv):
    def __init__(self, **kwargs):
        AntJumpEnv.__init__(self,)
        offline_env.OfflineEnv.__init__(self, **kwargs)
...
def get_AntJump_env(**kwargs):
    return OfflineAntJumpEnv(**kwargs)
